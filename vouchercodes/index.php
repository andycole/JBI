...
// Show Home link override
 $config['show_home_link']=false;
...
<?PHP include_once('inc/header.php') ?>
	...
	<div class="content">
		...
		<div class="main">
			...
			<h2>Welcome to the Voucher Framework!</h2>

			<p>This site is a simple framework to help you to build a voucher site quickly. It has a standard set of features, but is open to significant modification.<br>
			We hope you will use it as the basis for your own voucher site and customise the appearance and functionality to suit your needs.
			</p>
